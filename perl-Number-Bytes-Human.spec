...
Requires: perl-Number-Bytes-Human-man
...
%package man
Summary: man components for the perl-Number-Bytes-Human package.
Group: Default

%description man
man components for the perl-Number-Bytes-Human package.
...
mkdir -p %{_topdir}/BUILD/Number-Bytes-Human-0.11/deblicense/
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/Number/Bytes/Human.pm
